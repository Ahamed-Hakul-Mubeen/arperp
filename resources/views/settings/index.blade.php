        ...
        <div class="col-sm-12">
            <div class="row">
                ...
                {{--  Start for all settings tab --}}
                    ...
                    <!--Email Settings-->
                    <div id="email-settings" class="card d-none">
                        <div class="card-header">
                    ...
                    <!--Payment Settings-->
                    <div class="card d-none" id="payment-settings">
                        <div class="card-header">
                    ...
                    <!--Pusher Settings-->
                    <div id="pusher-settings" class="card d-none">
                        <div class="card-header">
                    ...
                    <!--ReCaptcha Settings-->
                    <div id="recaptcha_settings" class="card d-none">
                    ...
                    <!-- Storage Settings -->
                    <div id="storage-settings" class="card d-none mb-3">
                    ...
                    {{-- SEO settings --}}
                    <div id="seo-settings" class="card d-none">
                    ...
                    {{-- Cookie settings --}}
                    <div class="card d-none" id="cookie-settings">
                    ...
                    {{-- Cache settings --}}
                    <div class="card d-none" id="cache-settings">
                        <div class="card-header">
                    ...
                    {{-- chat gpt settings --}}
                    <div id="chat-gpt-settings" class="card d-none">
                        <div class="card-header">
