                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h3 class="mb-0">{{\Auth::user()->countConsolidatedCustomers()}}
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h3 class="mb-0">{{\Auth::user()->countConsolidatedVenders()}}
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h3 class="mb-0">{{\Auth::user()->countConsolidatedInvoices()}} </h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h3 class="mb-0">{{\Auth::user()->countConsolidatedBills()}} </h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            @forelse($recentInvoice as $invoice)
                                                <tr>
                                                    <td>{{\Auth::user()->invoiceConsolidatedNumberFormat($invoice->invoice_id)}}</td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            @forelse($recentBill as $bill)
                                                <tr>
                                                    <td>{{\Auth::user()->billConsolidatedNumberFormat($bill->bill_id)}}</td>
