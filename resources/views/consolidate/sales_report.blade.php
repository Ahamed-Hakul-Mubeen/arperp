...
@section('action-btn')
    ...
    <div class="float-end me-2">
        {{ Form::open(['route' => ['consolidate.sales.export']]) }}
        <input type="hidden" name="start_date" class="start_date">
        <input type="hidden" name="end_date" class="end_date">
        <input type="hidden" name="company" class="company" value="{{ isset($_GET['company'])?$_GET['company']:'' }}">
            ...
            <div class="col-md-12">
                <div class="mt-2" id="multiCollapseExample1">
                    <div class="card" id="show_filter" style="display:none;">
                        <div class="card-body">
                            {{ Form::open(['route' => ['consolidate.sales'], 'method' => 'GET', 'id' => 'report_sales']) }}
                                ...
                                <div class="col-auto mt-4">
                                    <div class="row">
                                        <div class="col-auto">
                                            ...
                                            <a href="{{ route('consolidate.sales') }}" class="btn btn-sm btn-danger "
