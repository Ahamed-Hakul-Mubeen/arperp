...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        {{ Form::open(array('route' => array('consolidate.quarterly.cashflow'),'method' => 'GET','id'=>'quarterly_cashflow')) }}
                        <div class="col-xl-12">
                                    ...
                                    <ul class="nav nav-pills my-3" id="pills-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-home-tab" data-bs-toggle="pill"
                                               href="{{ route('consolidate.monthly.cashflow') }}"
                                               onclick="window.location.href = '{{ route('consolidate.monthly.cashflow') }}'" role="tab"
                                ...
                                <div class="col-xl-9">
                                    <div class="row justify-content-end align-items-center">
                                        ...
                                        <div class="col-auto mt-4">
                                            ...
                                            <a href="{{route('consolidate.quarterly.cashflow')}}" class="btn btn-sm btn-danger " data-bs-toggle="tooltip"  title="{{ __('Reset') }}" data-original-title="{{__('Reset')}}">
