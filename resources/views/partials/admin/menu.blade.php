    ...
    <div class="navbar-content">
                    ...
                    <li
                        ...
                        <ul class="dash-submenu">
                            @if ($userPlan->account == 1 && Gate::check('show account dashboard'))
                                <li
                                    class="dash-item dash-hasmenu d-none {{ Request::segment(1) == null || Request::segment(1) == 'account-dashboard' || Request::segment(1) == 'report' || Request::segment(1) == 'reports-monthly-cashflow' || Request::segment(1) == 'reports-quarterly-cashflow' ? ' active dash-trigger' : '' }}">
                            ...
                            @if ($userPlan->crm == 1)
                                @can('show crm dashboard')
                                    <li
                                        class="dash-item dash-hasmenu d-none {{ Request::segment(1) == 'crm-dashboard' || Request::segment(1) == 'reports-lead' || Request::segment(1) == 'reports-deal' ? ' active dash-trigger' : '' }}">
                            ...
                            @if ($userPlan->project == 1)
                                @can('show project dashboard')
                                    <li
                                        class="dash-item d-none {{ Request::route()->getName() == 'project.dashboard' ? ' active' : '' }}">
                                        <a class="dash-link"
                    ...
                    <li
                        class="dash-item dash-hasmenu
                                     ...
                                     Request::segment(1) == 'debit-note'
                                         ? ' active dash-trigger'
                                         : '' }}">
                        <a href="#!" class="dash-link d-none"><span class="dash-micon"><i
        ...
        @if (!empty($userPlan) &&  $userPlan->project == 1)
            @if (Gate::check('manage project'))
                <li
                    class="dash-item dash-hasmenu d-none
        ...
        @if (\Auth::user()->type != 'super admin')
            @if (Gate::check('manage company plan') || Gate::check('manage order') || Gate::check('manage company settings') || Gate::check('manage bank account'))
                <li
        ...
        @if (\Auth::user()->type == 'super admin')
            <ul class="dash-navbar">
                ...
                @can('manage user')
                    ...
                    <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'consolidate' 
                        ? ' active dash-trigger'
                        : '' }}">
                    <a href="#!" class="dash-link d-none">
                        <span class="dash-micon"><i class="ti ti-clipboard"></i></span><span
                            class="dash-mtext">{{ __('Consolidate') }}</span>
                        <span class="dash-arrow">
                            <i data-feather="chevron-right"></i></span>
                    </a>
                    <ul class="dash-submenu">
                        <li class="dash-item dash-hasmenu {{Request::route()->getName() == 'consolidate.overview' ? ' active' : '' }}">
                            <a href="{{ route('consolidate.overview') }}"
                                class="dash-link">{{ __('Overview') }}</a>
                        </li>
                        <li class="dash-item {{ Request::route()->getName() == 'consolidate.account.statement' ? ' active' : '' }}">
                            <a href="{{ route('consolidate.account.statement') }}"
                                class="dash-link">{{ __('Account Statement') }}</a>
                        </li>
                        <li class="dash-item {{ Request::route()->getName() == 'consolidate.invoice.summary' ? ' active' : '' }}">
                            <a href="{{ route('consolidate.invoice.summary') }}" class="dash-link">{{ __('Invoice Summary') }}</a>
                        </li>
                        <li class="dash-item {{ Request::route()->getName() == 'consolidate.sales' ? ' active' : '' }}">
                            <a href="{{ route('consolidate.sales') }}" class="dash-link">{{ __('Sales Report') }}</a>
                        </li>
                        <li class="dash-item {{ Request::route()->getName() == 'consolidate.receivables' ? ' active' : '' }}">
                            <a href="{{ route('consolidate.receivables') }}" class="dash-link">{{ __('Receivables') }}</a>
                        </li>
                        <li class="dash-item {{ Request::route()->getName() == 'consolidate.payables' ? ' active' : '' }}">
                            <a href="{{ route('consolidate.payables') }}" class="dash-link">{{ __('Payables') }}</a>
                        </li>
                        <li class="dash-item {{ Request::route()->getName() == 'consolidate.bill.summary' ? ' active' : '' }}">
                            <a href="{{ route('consolidate.bill.summary') }}" class="dash-link">{{ __('Bill Summary') }}</a>
                        </li>
                        <li class="dash-item {{ Request::route()->getName() == 'consolidate.product.stock' ? ' active' : '' }}">
                            <a href="{{ route('consolidate.product.stock') }}" class="dash-link">{{ __('Product Stock') }}</a>
                        </li>
                        <li class="dash-item {{ Request::route()->getName() == 'consolidate.monthly.cashflow' ? ' active' : '' }}">
                            <a href="{{ route('consolidate.monthly.cashflow') }}" class="dash-link">{{ __('Cash Flow') }}</a>
                        </li>
                        <li class="dash-item {{ Request::route()->getName() == 'consolidate.transaction' ? ' active' : '' }}">
                            <a href="{{ route('consolidate.transaction') }}" class="dash-link">{{ __('Transaction') }}</a>
                        </li>
                        <li class="dash-item {{ Request::route()->getName() == 'consolidate.income.summary' ? ' active' : '' }}">
                            <a href="{{ route('consolidate.income.summary') }}" class="dash-link">{{ __('Income Summary') }}</a>
                        </li>
                        <li class="dash-item {{ Request::route()->getName() == 'consolidate.expense.summary' ? ' active' : '' }}">
                            <a href="{{ route('consolidate.expense.summary') }}" class="dash-link">{{ __('Expense Summary') }}</a>
                        </li>
                        <li class="dash-item {{ Request::route()->getName() == 'consolidate.income.expense' ? ' active' : '' }}">
                            <a href="{{ route('consolidate.income.expense') }}" class="dash-link">{{ __('Income VS Expense') }}</a>
                        </li>
                        <li class="dash-item {{ Request::route()->getName() == 'consolidate.tax.summary' ? ' active' : '' }}">
                            <a href="{{ route('consolidate.tax.summary') }}" class="dash-link">{{ __('Tax Summary') }}</a>
                        </li>
                    </ul>
                </li>
                ...
                @if (Gate::check('manage plan'))
                    <li class="dash-item dash-hasmenu d-none  {{ Request::segment(1) == 'plans' ? 'active' : '' }}">
