...
use App\Http\Controllers\Consolidate\OverviewController;
use App\Http\Controllers\Consolidate\InvoiceSummaryController;
use App\Http\Controllers\Consolidate\SalesReportController;
use App\Http\Controllers\Consolidate\ReceivablesController;
use App\Http\Controllers\Consolidate\PayableController;
use App\Http\Controllers\Consolidate\BillSummaryController;
use App\Http\Controllers\Consolidate\CashflowController;
use App\Http\Controllers\Consolidate\IncomeSummaryController;
use App\Http\Controllers\Consolidate\ExpenseSummaryController;
use App\Http\Controllers\Consolidate\TaxSummaryController;
use App\Http\Controllers\Consolidate\AccountStatementController;
use App\Http\Controllers\Consolidate\IncomeVsExpenseController;
use App\Http\Controllers\Consolidate\ProductStockController as ConsolidatedProductStockController;
use App\Http\Controllers\Consolidate\TransactionController as ConsolidateTransactionController;
...
//    Route::get('timesheet-table-view', [TimesheetController::class, 'filterTimesheetTableView'])->name('filter.timesheet.table.view')->middleware(['auth', 'XSS']);
    ...
    Route::group(
        [
            ...
            // consolidate Reports
            Route::get('/consolidate/invoice-summary', [InvoiceSummaryController::class, 'index'])->name('consolidate.invoice.summary');
            Route::get('/consolidate/sales', [SalesReportController::class, 'index'])->name('consolidate.sales');
            Route::post('/consolidate/sales/export', [SalesReportController::class, 'export'])->name('consolidate.sales.export');
            Route::get('/consolidate/receivables', [ReceivablesController::class, 'index'])->name('consolidate.receivables');
            Route::get('/consolidate/payables', [PayableController::class, 'index'])->name('consolidate.payables');
            Route::get('/consolidate/bill-summary', [BillSummaryController::class, 'index'])->name('consolidate.bill.summary');
            Route::get('/consolidate/product-stock-report', [ConsolidatedProductStockController::class, 'index'])->name('consolidate.product.stock');
            Route::get('/consolidate/monthly-cashflow', [CashflowController::class, 'monthly'])->name('consolidate.monthly.cashflow');
            Route::get('/consolidate/quarterly-cashflow', [CashflowController::class, 'quarterly'])->name('consolidate.quarterly.cashflow');
            Route::get('/consolidate/transaction', [ConsolidateTransactionController::class, 'index'])->name('consolidate.transaction');
            Route::get('/consolidate/income-summary', [IncomeSummaryController::class, 'index'])->name('consolidate.income.summary');
            Route::get('/consolidate/expense-summary', [ExpenseSummaryController::class, 'index'])->name('consolidate.expense.summary');
            Route::get('/consolidate/income-expense', [IncomeVsExpenseController::class, 'index'])->name('consolidate.income.expense');
            Route::get('/consolidate/tax-summary', [TaxSummaryController::class, 'index'])->name('consolidate.tax.summary');
            Route::get('/consolidate/account-statement', [AccountStatementController::class, 'index'])->name('consolidate.account.statement');
            Route::get('/consolidate/overview', [OverviewController::class, 'index'])->name('consolidate.overview');
